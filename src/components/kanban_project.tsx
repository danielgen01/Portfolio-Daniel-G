  ...
  return (
    <div className="grid-layout grid grid-cols-1 lg:grid-cols-2 mx-10 mt-10 bg-gray-500/10 rounded-md p-5">
      <div className="grid-item-image-container lg:order-2">
        <img src={kanbanscreen} alt="E-Commerce-Screenshot" />
      </div>
      <div className="project-description text-white flex flex-col items-center gap-5 justify-between">
        <h1 className="font-semibold text-3xl text-center">
          Kanban Task Management Business App
        </h1>
        <h2 className="lg:text-2xl text-lg lg:mx-20">
          I built an Kanbanboard from scratch.This board is also connected to
          localstorage to save your changes. I used React with Typescript to
          build components and Redux for state management. I styled my app with
          TailwindCSS.
        </h2>
        ...
        <div className="buttons grid grid-cols-1 lg:grid-cols-2 gap-5">
          <a
            href="https://kanban-project-by-daniel-g.netlify.app/"
            target={"_blank"}
          ...
          <a
            href="https://github.com/danielgen01/kanbanboard-frontend"
