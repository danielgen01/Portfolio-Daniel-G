...
const AboutMe: React.FC = () => {
  return (
    <>
      ...
      >
        <h1 className="text-2xl lg:text-6xl font-bold">About me</h1>
        <h2 className=" text-xl lg:text-3xl mx-10 lg:mx-72 font-medium">
          Hello, my name is Daniel Adrian Gendik and I'm a ambitious self taught
          frontend web developer, who dreams about code.
        </h2>
        <h3 className=" text-lg lg:text-2xl mx-10 lg:mx-72 font-normal">
